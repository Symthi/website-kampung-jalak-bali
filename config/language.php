...
function get_hardcoded_strings() {
    return [
        'id' => [
            ...
            'history' => 'Kelahiran Kembali Sang Endemik',
            'history_paragraph1' => 'Program pelepasliaran dan perlindungan Burung Jalak Bali ini berakar dari kearifan lokal Desa Adat Tingkihkerep, Tengkudak, Tabanan. Jauh sebelum program resmi diluncurkan, masyarakat telah menjamin perlindungan satwa melalui Awig-Awig Desa Adat yang melarang perburuan, didasarkan pada filosofi Tri Hita Karana—keseimbangan harmonis antara manusia, alam, dan spiritualitas.Berbekal fondasi budaya yang kuat ini, Yayasan FNPF memulai program Konservasi Ex-Situ ini. Setelah melalui kajian habitat ilmiah, aksi nyata dimulai pada April 2024 dengan pelepasliaran awal 60 ekor Jalak Bali.',
            'history_paragraph2' => 'Momen puncaknya terjadi pada Juni 2024, saat Kampoeng Jalak Bali diresmikan oleh Bupati Tabanan. Peresmian ini menegaskan peran desa ini sebagai lokasi utama perlindungan satwa endemik Bali. Hingga saat ini, program tersebut terbukti sukses: populasi Jalak Bali liar terus bertambah. Bukti paling nyata adalah keberhasilan 30 ekor anakan Jalak Bali menetas dan hidup bebas di alam secara alami dalam periode April 2024 hingga September 2025.',
            'background' => 'Nilai Konservasi Berbasis Budaya',
            ...
            'Background_paragraph2' => 'Fondasi Budaya Lokal:
-Masyarakat Bali memiliki hari pemuliaan khusus, yaitu Tumpek Kandang sebagai hari pemuliaan binatang/satwa, dan Tumpek Uduh/Bubuh sebagai hari pemuliaan tumbuhan.
-Pelestarian tumbuhan dan satwa adalah satu kesatuan yang tak terpisahkan dalam konsep Tri Hita Karana.
-Tri Hita Karana adalah filosofi hidup masyarakat Bali yang berarti "tiga penyebab kebahagiaan," yaitu hubungan harmonis antara manusia dengan Tuhan (Parahyangan), manusia dengan sesama (Pawongan), dan manusia dengan lingkungan (Palemahan).
-Pengamalan konsep Tri Hita Karana ini dilakukan melalui Awig-Awig dan Perarem Desa Adat yang secara tegas melarang segala bentuk aktivitas perburuan, penangkapan, atau perdagangan satwa liar di wilayah desa.',
            'vision' => 'Visi',
            'mission' => 'Misi',
            ...
            'advisor' => 'Pembina',
            'responsible_party' => 'Penanggung jawab',
            'chairperson' => 'Ketua',
            ...
            'position_adat_leader' => 'Bendesa Adat Tingkihkerep',
