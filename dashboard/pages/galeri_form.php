...
.form-group input, .form-group textarea{width:100%;padding:0.7rem;font-size:0.9rem;border:1px solid #ddd;border-radius:4px;font-family:inherit}
...
<a href="?page=galeri" class="back-link"><i class="fa fa-arrow-left"></i> Kembali ke Daftar</a>
...
<div class="form-wrapper">
    <form method="POST" action="?page=galeri" enctype="multipart/form-data">
        <?php if ($edit_data): ?>
        ...
        <div class="form-group">
            ...
            <?php if ($edit_data && $edit_data['gambar']): ?>
                <div class="form-preview-box">
                    ...
                    <img src="<?php echo $base . '/' . $edit_data['gambar']; ?>" class="img-preview" onerror="this.src='https://source.unsplash.com/random/200x150/?bali'">
                </div>
            <?php endif; ?>
        </div>
