...
<a href="?page=wisata" class="back-link"><i class="fa fa-arrow-left"></i> Kembali ke Daftar</a>
...
<div class="form-wrapper">
    <form method="POST" action="?page=wisata" enctype="multipart/form-data">
        <?php if ($edit_data): ?>
        ...
        <div class="form-group">
            ...
            <input type="time" id="jam" name="jam" value="<?php echo htmlspecialchars($edit_data['jam'] ?? ''); ?>" required>
        </div>
        ...
        <div class="form-group">
            ...
            <?php if ($edit_data && $edit_data['gambar']): ?>
                <div class="form-preview-box">
                    ...
                    <img src="<?php echo $base . '/' . $edit_data['gambar']; ?>" class="img-preview" onerror="this.src='https://source.unsplash.com/random/200x150/?travel'">
                </div>
            <?php endif; ?>
        </div>
